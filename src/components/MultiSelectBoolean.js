	...
	render() {
		return (
			<div>
				...
				{(this.state.showOptions)?<Card style={{ width: "20%" }}><CardContent><RadioButtonsGroup value= {this.props.value.boolean} onChange={(value)=>this.onBooleanValueChange(value)}/>
